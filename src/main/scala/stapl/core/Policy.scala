 ...
 */
class Policy(id: String)(var target: Expression = AlwaysTrue, val pca: CombinationAlgorithm, 
    var subpolicies: List[AbstractPolicy], val obligations: List[Obligation] = List.empty) 
	extends AbstractPolicy(id) with Logging {
